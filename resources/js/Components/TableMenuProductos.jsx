                        ...
                        {currentProducts.map((data) => (
                            ...
                            >
                                <div
                                    role="button"
                                    tabIndex="0"
                                    aria-label={`Agregar ${data.nombre}`}
                                    className={`p-4 border rounded-md cursor-pointer transition-colors ${selectedProduct?.id !== data.id
                                ...
                                >
                                    ...
                                    <div className="flex justify-between items-center mt-2">
                                        ...
                                        <button
                                            ...
                                            aria-label={`Confirmar agregar ${data.nombre}`}
                                        >
                                            <svg
...
export default TableMenuProductos;