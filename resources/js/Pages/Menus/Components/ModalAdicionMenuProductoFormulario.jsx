...
export default function ModalAdicionMenuProductoFormulario({
    productos,
    addMenuProducto,
    showAdicionarProductModal,
    setAdicionarProductModal,
    menuProductos,
    menu
}) {
    ...
    useEffect(() => {
        const filtered = productos.filter(producto => {
            const isNotInMenu = !menuProductos.some(item => item.producto_id === producto.id);
    ...
    const submitAddProducto = (producto) => {
        ...
        router.visit('/menu-producto', {
            ...
            data: {
                ...
                setAdicionarProductModal(false); // Cerrar modal después de agregar
            }
        });
    }
    ...
    return (
        <Modal
            show={showAdicionarProductModal}
            onClose={() => setAdicionarProductModal(false)}
            maxWidth="5xl"
            aria-modal="true"
            role="dialog"
        >
            <div className="p-6">
                <div className="flex justify-between items-center mb-4">
                    ...
                    <button
                        onClick={() => setAdicionarProductModal(false)}
