...
export default function Index({ productos, filters }) {
    ...
    const handleSearch = (e) => {
        e.preventDefault();
        router.get(route('productos.index'), { search }, { preserveState: false, preserveScroll: true });
    };
    ...
    const startCreating = () => {
        router.get(route('producto.create'));
    };
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-4">
                        <div className="flex items-center justify-between flex-wrap">
                            <span className="text-sm text-gray-700 dark:text-gray-300 mb-2 sm:mb-0">
                                Página <strong>{productos.current_page}</strong> de <strong>{productos.last_page}</strong>
                            </span>
